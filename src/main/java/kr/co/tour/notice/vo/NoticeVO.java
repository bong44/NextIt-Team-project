...
public class NoticeVO implements Serializable{
	...
	private String boPrimaryYn;        /* 글 고정 여부 */
	...
	public String getBoPrimaryYn() {
		return boPrimaryYn;
	}


	public void setBoPrimaryYn(String boPrimaryYn) {
		this.boPrimaryYn = boPrimaryYn;
	}
