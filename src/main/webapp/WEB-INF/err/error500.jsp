<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page isErrorPage="true" %> <%--isErrorPage가 true일 때 Exception 로컬변수 사용가능 --%>

<!DOCTYPE html>
<html lang="ko" class="os_mac chrome pc version_56_0_2924_87">
<head>
	<meta charset="utf-8">
		<title>Jiwon 원하시는 페이지를 찾을 수가 없습니다.</title>
...
<div id="kakaoWrap" class="page_error">
	...
	<div id="kakaoContent" class="cont_error" role="main">
				<h2 class="tit_error">500에러가 나서<span class="emph_txt">찾을 수가 없습니다.</span></h2>
		<p class="desc_error">
			요청을 처리중 오류가 발생했습니다.,<br>
			예외타입 : <%=exception.getClass().getName() %> <br>	
			메시지 : <%=exception.getMessage() %> <br>
			지속적인 오류가 발생하시면 넥스트(042-719-8850)으로 문의주세요..
		</p>
		<p class="desc_error">
